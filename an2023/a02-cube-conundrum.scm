...
(define cube1 "Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green
    Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue
    Game 3: 8 green, 6 blue, 20 red; 5 blue, 4 red, 13 green; 5 green, 1 red
    Game 4: 1 green, 3 red, 6 blue; 3 green, 6 red; 3 green, 15 blue, 14 red
    Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green
...
(define (game-id game-str)
  (locale-string->integer
   (second (string-split game-str #\space))))

(define-record-type <set-of-cubes>
  (make-set-of-cubes red green blue)
  set-of-cubes?
  (red cubes-red set-cubes-red!)
  (green cubes-green set-cubes-green!)
  (blue cubes-blue set-cubes-blue!))
...
;; (define (solve-cube port blue red green)
...
;;         ;; Dacă avem id-joc, îl adăugăm la sumă înainte
;;         (if (nil? id-joc)
;;             suma
;;             (+ suma id-joc))
;;         ;; avem un joc nou pe care să îl procesăm
;;         (letrec* ((id+games (string-split ln #\:))
;;                   (games (string-split ()))))
;;         (let game-on ((game ln)
;;                       (id1 #nil)
;;                       (red #nil)
...
;; (call-with-input-string cube1 solve-cube) ;
